...
export const PROJECTS_V2: ProjectV2[] = [
  ...
  // sumber fakta soal stack produk beneran.
  {
    ...
    shortDescription: "All-in-one AI workspace for content creators — image generation, video production, auto-clipping, and content automation in a single platform.",
    description: null,
    problem: null,
    solution: null,
    architecture: null,
    features: null,
    technologies: ["Next.js", "Supabase", "Vercel", "Telegram Bot API"],
    images: [],
    liveUrl: "https://ai-creator-hub-zeta.vercel.app/",
    githubUrl: null,
    status: "draft",
    visibility: "public",
  },
  {
    ...
    architecture: null,
    features: null,
    technologies: ["Next.js", "TypeScript", "Supabase (Postgres, Auth, RLS)", "Google Places API", "Discord.js", "OpenRouter / Groq (LLM)", "Vercel", "PM2"],
    images: [],
  ...
  },
  {
    ...
    category: "ai-system",
    projectType: "AI System",
    shortDescription: "Automated intelligence pipeline that continuously monitors 9 sources — GitHub Trending, Hacker News, Reddit, Google Trends, Product Hunt, Detik Finance, and remote job boards (WeWorkRemotely, RemoteOK, NoDesk) — then scores and surfaces the most relevant tech/business signals and job openings every 6 hours. Built to stay ahead of fast-moving information and opportunities without manually checking a dozen sites.",
    description: null,
    problem: null,
    solution: null,
    architecture: null,
    features: null,
    technologies: ["Next.js", "TypeScript", "Supabase (Postgres)", "Cron", "Multi-source signal aggregation"],
    images: [],
    liveUrl: null,
    githubUrl: null,
    status: "live",
