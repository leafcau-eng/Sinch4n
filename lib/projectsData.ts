...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tech: ["HTML", "CSS", "JS"],
    url: "https://sch-demo.vercel.app/demo/contoh-parfum",
    thumb: "🌸",
    color: "linear-gradient(135deg,#3c0d2f,#1a0d3c)",
    thumbnailUrl: "https://api.microlink.io/?url=https://sch-demo.vercel.app/demo/contoh-parfum&screenshot=true&meta=false&embed=screenshot.url",
  },
  {
    id: 5,
    ...
    tech: ["HTML", "CSS", "JS"],
    url: "https://sch-demo.vercel.app/demo/contoh-petshop",
    thumb: "🐾",
    color: "linear-gradient(135deg,#0d3c1f,#0d2137)",
    thumbnailUrl: "https://api.microlink.io/?url=https://sch-demo.vercel.app/demo/contoh-petshop&screenshot=true&meta=false&embed=screenshot.url",
  },
  {
    id: 6,
    name: "Toko UMKM Demo",
    ...
    tech: ["HTML", "CSS", "JS"],
    url: "https://sch-demo.vercel.app/demo/contoh-toko-umkm",
    thumb: "🛒",
    color: "linear-gradient(135deg,#3c2f0d,#1a0d37)",
    thumbnailUrl: "https://api.microlink.io/?url=https://sch-demo.vercel.app/demo/contoh-toko-umkm&screenshot=true&meta=false&embed=screenshot.url",
  },
  {
    id: 7,
    ...
    tech: ["HTML", "CSS", "JS"],
    url: "https://sch-demo.vercel.app/demo/contoh-car-elite",
    thumb: "🏎️",
    color: "linear-gradient(135deg,#0d1f3c,#1a0d0d)",
    thumbnailUrl: "https://api.microlink.io/?url=https://sch-demo.vercel.app/demo/contoh-car-elite&screenshot=true&meta=false&embed=screenshot.url",
  },
  {
    id: 8,
    ...
    tech: ["HTML", "CSS", "JS"],
    url: "https://sch-demo.vercel.app/demo/contoh-property-elite",
    thumb: "🏙️",
    color: "linear-gradient(135deg,#0d2137,#0d3c3c)",
    thumbnailUrl: "https://api.microlink.io/?url=https://sch-demo.vercel.app/demo/contoh-property-elite&screenshot=true&meta=false&embed=screenshot.url",
  },
];
